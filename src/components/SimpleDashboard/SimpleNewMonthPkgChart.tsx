...
const SimpleNewMonthPkgChart: React.FC = () => {
  ...
  const option = useMemo(() => {
    ...
    const seriesDefs = [
      { name: labels.newMonthYearlyLabel, type: 'line' as const, values: data.newMonthYearlyConfirmed, color: COLORS.yearly },
      { name: labels.newMonthMonthlyLabel, type: 'line' as const, values: data.newMonthMonthlyConfirmed, color: COLORS.monthly },
      { name: labels.newMonthOrderLabel, type: 'bar' as const, values: data.newMonthOrderAmount, color: COLORS.order },
    ];
  ...
  return (
    <div className={styles.chartCard}>
      <div className={styles.chartTitle}>{t.newMonthPkgTitle}</div>
